...
#define IIMPC_PACK_REQUESTS_BITS_SET_CALIB_MEAS(var)    	__IMMPC_SET_BIT(var, 	IIMPC_PACK_REQUESTS_BITS_CALIB_MEAS)
#define IIMPC_PACK_REQUESTS_BITS_SET_RAW_MEAS(var)      	__IMMPC_CLEAR_BIT(var, 	IIMPC_PACK_REQUESTS_BITS_CALIB_MEAS)
#define __IIMPC_PACK_REQUESTS_BITS_IsSetCalibMeas(var)		__IMMPC_IS_SET_BIT(var, IIMPC_PACK_REQUESTS_BITS_CALIB_MEAS);

#define IIMPC_PACK_REQUESTS_BITS_SET_RESERV_MEAS(var)		__IMMPC_SET_BIT(var, 	IIMPC_PACK_REQUESTS_BITS_RESERV_MEAS)
#define IIMPC_PACK_REQUESTS_BITS_SET_MAIN_MEAS(var)    		__IMMPC_CLEAR_BIT(var, 	IIMPC_PACK_REQUESTS_BITS_RESERV_MEAS)
#define __IIMPC_PACK_REQUESTS_BITS_IsSetReservMeas(var) 	__IMMPC_IS_SET_BIT(var, IIMPC_PACK_REQUESTS_BITS_RESERV_MEAS)

#define IIMPC_PACK_REQUESTS_BITS_SET_READ_MEAS(var)			__IMMPC_SET_BIT(var, 	IIMPC_PACK_REQUESTS_BITS_READ_MEAS)
#define IIMPC_PACK_REQUESTS_BITS_SET_NOT_READ_MEAS(var)		__IMMPC_CLEAR_BIT(var, 	IIMPC_PACK_REQUESTS_BITS_READ_MEAS)
#define __IIMPC_PACK_REQUESTS_BITS_IsSetReadFlag(var)		__IMMPC_IS_SET_BIT(var, IIMPC_PACK_REQUESTS_BITS_READ_MEAS)

#define IIMPC_PACK_REQUESTS_BITS_SET_REQUEST(var)			__IMMPC_SET_BIT(var, 	IIMPC_PACK_REQUESTS_BITS_IS_DATA_REQUEST)
#define IIMPC_PACK_REQUESTS_BITS_SET_DATA_PAYLOAD(var)		__IMMPC_CLEAR_BIT(var, 	IIMPC_PACK_REQUESTS_BITS_IS_DATA_REQUEST)
#define __IIMPC_PACK_REQUESTS_BITS_IsSetDataRequest(var)	__IMMPC_IS_SET_BIT(var, IIMPC_PACK_REQUESTS_BITS_IS_DATA_REQUEST)
